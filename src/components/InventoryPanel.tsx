...
export function InventoryPanel() {
  ...
  return (
    <aside className="flex flex-col gap-4 sm:flex-row md:col-span-2 xl:min-h-[calc(100vh-3rem)] xl:col-auto xl:flex-col">
      <section className="flex-1 rounded-lg border border-stone-800 bg-stone-900/80 p-4 sm:p-5">
          ...
          <ul className="mt-5 space-y-3 text-sm text-stone-300">
            {player.inventory.map((item, index) => (
              ...
              >
                ...
                <div className="mt-3 flex gap-2 xl:opacity-0 xl:transition xl:group-hover:opacity-100">
                  {'attack' in item ? (
                    <button
